...
public class OkgoProcessor implements IHttpProcessor {
    private String TAG = "OkGoProcessor";

    @Override
    public void post(final IRequest iRequest, final ICallback callback) {
        HttpParams params = new HttpParams();
        Map<String, Object> body = iRequest.body();
        ...
        String url = iRequest.url(IRequest.RequestType.POST);
        OkGo.post(url)
                .tag(iRequest.tag())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        Log.e(iRequest.getClass().getSimpleName(), iRequest.tag());
                        super.onError(call, response, e);
                        Log.e(iRequest.getClass().getSimpleName(), e.toString());
    ...
    @Override
    public void get(final IRequest iRequest, final ICallback iCallback) {
        String url = iRequest.url(IRequest.RequestType.GET);
        Log.i(TAG+":url",url);
        OkGo.get(url)
                .tag(iRequest.tag())
                .cacheKey(iRequest.tag())
                .cacheMode(CacheMode.DEFAULT)
                .execute(new StringCallback() {
                    @Override
                    public void onSuccess(String s, Call call, Response response) {
