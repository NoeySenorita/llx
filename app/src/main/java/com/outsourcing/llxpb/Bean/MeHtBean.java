...
public class MeHtBean {

    /**
     * code : 0
     * message : success
     * data : {"contract_summary":{"accept_total":4,"apply_total":462231},"contract_stat":[{"id":24,"code":"CHHKH02","name":"黄黄高铁-康华合同02","show_name":"黄黄高铁-康华合同02","apply_amount":255081,"accept_amount":4},{"id":25,"code":"CHHKH03","name":"黄黄高铁-康华合同03","show_name":"黄黄高铁-康华合同03","apply_amount":207150,"accept_amount":0}],"matter_stat":{"matter_count":12}}
     */
    ...
    public static class DataBean {
        /**
         * contract_summary : {"accept_total":4,"apply_total":462231}
         * contract_stat : [{"id":24,"code":"CHHKH02","name":"黄黄高铁-康华合同02","show_name":"黄黄高铁-康华合同02","apply_amount":255081,"accept_amount":4},{"id":25,"code":"CHHKH03","name":"黄黄高铁-康华合同03","show_name":"黄黄高铁-康华合同03","apply_amount":207150,"accept_amount":0}]
         * matter_stat : {"matter_count":12}
         */
        ...
        public static class MatterStatBean {
            ...
            private String matter_count;

            public String getMatter_count() {
                return matter_count;
            }

            public void setMatter_count(String matter_count) {
