...
import com.outsourcing.llxpb.adapter.EarlyWarningAdapter2;
...
public class EarlyWarningFragment2 extends BaseFragment {
    private RecyclerView mRl1;
    List<EarlyWBean2.DataBean> mDataBeans;
    private EarlyWarningAdapter2 mEarlyWarningAdapter2;

    @Override
    public View getContentView() {
        return View.inflate(getContext(), R.layout.fragment_early_warning2,null);
    }
    ...
    protected void initContentView(View contentView) {
        ...
        mEarlyWarningAdapter2 = new EarlyWarningAdapter2(this.getContext(), mDataBeans);
        mRl1.setAdapter(mEarlyWarningAdapter2);
        contentView.findViewById(R.id.mg).setVisibility(View.GONE);
    ...
    public void getData() {
        OkGo.get(HttpHost.httpHost + "/subcontractor/warning/overAge")
                .headers("Content-Type", "application/json")
                .headers("token", UserUtil.token)
                .headers("uuid", UserUtil.uuid)
                .headers("project_id", UserUtil.projectId)
                .execute(new JsonCallBack<EarlyWBean2>() {
                    @Override
                    public void onSuccess(EarlyWBean2 earlyWBean1, okhttp3.Call call, okhttp3.Response response) {
                        if(EarlyWarningFragment2.this.getContext() != null){
                            ...
                            if (mEarlyWarningAdapter2 != null&&earlyWBean1 != null && earlyWBean1.getCode()==0) {
                                ...
                                if(EarlyWarningFragment2.this.getContext() != null){
                                    ...
                                    T.showLong(EarlyWarningFragment2.this.getContext(), earlyWBean1.getMessage());
                                }
